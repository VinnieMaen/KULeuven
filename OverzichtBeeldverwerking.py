...
# Herschalen van de afbeelding (hoogte neemt af met 100px) WAARSCHIJNLIJK FOUT OMWILLE DIT BIJKNIPT EN NIET VERKLEINT
...
# Herschalen van de afbeelding (breedte neemt af met 100px) WAARSCHIJNLIJK FOUT OMWILLE DIT BIJKNIPT EN NIET VERKLEINT
